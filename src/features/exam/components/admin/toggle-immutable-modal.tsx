...
interface ToggleImmutableModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
      ...
      <DialogContent className="max-w-md font-mono">
        <DialogHeader className="flex flex-col items-center gap-2 text-center sm:text-left">
          ...
          <DialogDescription className="text-center font-mono text-xs leading-relaxed text-gray-600">
            Are you sure you want to set this exam status to{' '}
            ...
            <span className="mt-1 block text-[11px] text-gray-400">
              {targetState
                ? 'Immutable exams prevent modification.'
                : 'Mutable exams allow admins to edit details and questions.'}
            </span>
          </DialogDescription>
        </DialogHeader>
